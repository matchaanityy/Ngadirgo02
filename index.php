...
// Query untuk hitung jumlah guru
$queryGuru = mysqli_query($conn, "SELECT COUNT(*) AS jumlahGuru FROM profile_guru");
$dataGuru = mysqli_fetch_assoc($queryGuru);
$jumlahGuru = $dataGuru['jumlahGuru'];
// Query untuk hitung jumlah siswa
$querySiswa = mysqli_query($conn, "SELECT SUM(jumlah_siswa) AS total_siswa FROM profile_siswa");
$dataSiswa = mysqli_fetch_assoc($querySiswa);
$jumlahSiswa = $dataSiswa['total_siswa'];

$queryRuangan = mysqli_query($conn, "SELECT COUNT(*) AS jumlahRuangan FROM fasilitas");
$dataRuangan = mysqli_fetch_assoc($queryRuangan);
$jumlahRuangan = $dataRuangan['jumlahRuangan'];
?>
...
<body>
    <header>
        <img src="image/logo.png" alt="Logo Sekolah" class="logo">
            <div class="header-text">
            <h1>WELCOME TO WEBSITE</h1>
            <h2>SD NEGERI NGADIREGO 02</h2>
            <p>Pendidikan Berkualitas, Masa Depan Gemilang</p>
            </div>
        </header>
        ...
        <nav>
            <a href="http://localhost/Ngadirgo02/">BERANDA</a>
                ...
                <a href="http://localhost/ngadirgo02/user/berita.php">BERITA</a>
                <div class="dropdown">
            ...
            <a href="https://spmb.semarangkota.go.id/sd">PPDB</a>
        ...
        <div class="container">
            ...
            <div class="stat-box">
                ...
                <p><strong>Jumlah Tenaga Pendidik</strong><br><?= $jumlahGuru ?> Tenaga Pendidik</p>
            </div>
            <div class="stat-box">
                <img src="image/drumband.jpg" alt="Siswa">
                <p><strong>Jumlah Siswa</strong><br><?= $jumlahSiswa ?> Siswa</p>
            </div>
            <div class="stat-box">
                <img src="image/ruang kelas.jpg" alt="Ruang">
                <p><strong>Jumlah Ruangan</strong><br><?= $jumlahRuangan ?> Ruang</p>
            </div>
            </div>
            ...
            <div class="sambutan-card">
                ...
                <div class="sambutan-img">
                    <img src="image/gambar 7.jpeg" alt="Foto Kepala Sekolah">
                </div>
                <div class="sambutan-text">
                    <h5>SAMBUTAN KEPALA SEKOLAH</h5>
                    <p style="text-align: justify">Puji syukur kami panjatkan kehadirat  Allah SWT, Tuhan Yang Maha Esa yang telah memberikan rahmat dan hidayahNya sehingga pembuatan website SD Negeri Ngadirgo 02 Kota Semarang ini dapat terlaksana dengan lancartanpa suatu halangan apa pun. kami merasa bangga mendapatkan kesempatan untuk mengikuti workshop pelatihan pembuatan website sekolah. Kami akan berupaya untuk mengembangkan ilmu yang sudah diberikan melalui workshop untuk kemajuan Negeri Ngadirgo 02 terutama dibidang pendidikan dan memeberikan informasi secara detail tentang Negeri Ngadirgo 02.</p>
                </div>
                </div>
            </div>
            ...
            <div class="berita">
                ...
                <div class="berita-info">
                    <small>29 Juli 2025</small>
                    <p><a href="https://disdiksmg.semarangkota.go.id/post-detail/peringatan-hari-anak-nasional-2025-sekolah-di-kota-semarang-penuhi-ruang-belajar-dengan-keceriaan-dan-kearifan-budaya">Peringatan Hari Anak Nasional 2025</a></p>
                </div>
                </div>

                <div class="berita-cards">
                <img src="image/bambang.webp" alt="Berita 2">
                <div class="berita-info">
                    <small>30 Juli 2025</small>
                    <p><a href="https://www.antaranews.com/berita/4922701/disdik-semarang-gelar-spmb-gelombang-2-atasi-sd-minim-siswa">Disdik Semarang gelar SPMB gelombang 2 atasi SD minim siswa</a></p>
                </div>
                </div>

                <div class="berita-cards">
                <img src="image/suharwoto.webp" alt="Berita 3">
                <div class="berita-info">
                    <small>19 Juni 2025</small>
                    <p><a href="https://www.antaranews.com/berita/4911365/kolaborasi-pusat-dan-daerah-wujudkan-pendidikan-bermutu-untuk-semua">Kolaborasi Pusat dan Daerah Wujudkan Pendidikan Bermutu untuk Semua</a></p>
                </div>
                </div>

                <div class="berita-cards">
                <img src="image/semarang.jpg.webp" alt="Berita 4">
                <div class="berita-info">
                    <small>26 Juni 2025</small>
                    <p><a href="https://www.antaranews.com/berita/4696317/wali-kota-semarang-jangan-sampai-siswa-miskin-tak-bisa-sekolah">Wali Kota Semarang: Jangan sampai siswa miskin tak bisa sekolah</a></p>
                </div>
                </div>

                <div class="berita-cards">
                <img src="image/gubernur.webp" alt="Berita 4">
                <div class="berita-info">
                    <small>26 Juni 2025</small>
                    <p><a href="https://www.antaranews.com/berita/4973833/pemkot-semarang-siapkan-sekolah-rakyat-di-daerah-rowosari">Pemkot Semarang siapkan sekolah rakyat di daerah Rowosari</a></p>
                </div>
                </div>

                <div class="berita-cards">
                <img src="image/kemensos.webp" alt="Berita 4">
                <div class="berita-info">
                    <small>26 Juni 2025</small>
                    <p><a href="https://www.antaranews.com/berita/4706809/mensos-dan-kepala-daerah-di-jateng-matangkan-rencana-sekolah-rakyat#google_vignette">Mensos dan kepala daerah di Jateng matangkan rencana Sekolah Rakyat</a></p>
                </div>
                </div>
            </div>
            ...
            <!-- Peta -->
            <div class="map">
                <h3>PETA SDN NGADIRGO 02</h3>
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d311.81951624118744!2d110.31153776825559!3d-7.025630054157142!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e7061cbe6c6b619%3A0x908e62225dd1a998!2sSekolah%20Dasar%20Negeri%20Ngadirgo%2002!5e0!3m2!1sid!2sid!4v1751438460043!5m2!1sid!2sid" allowfullscreen></iframe>
            </div>
        ...
        <footer class="footer">
            <div class="footer-col">
                ...
                <ul>
                    <li>
                        <a href="https://www.kemdikbud.go.id/" class="footer-link">
                    ...
                    <li>
                        <a href=https://disdiksmg.semarangkota.go.id class="footer-link">
            ...
            <div class="footer-col">
                ...
                <ul>
                    <li>
                        <a href="https://www.youtube.com/sdnngadirgo02" class="footer-link">    
                    ...
                    <li>
                        <a href="https://www.instagram.com/sdnngadirgo02" class="footer-link">
            ...
            <div class="footer-col">
                ...
                <ul>
                <li>
                    <a href="https://maps.google.com/?q=SD+Negeri+Ngadirgo+02" class="footer-link">
                ...
                <li>
                    <a href="tel:081332730489" class="footer-link">
                ...
                <li>
                    <a href="mailto:sdnngadirgo02mijen@gmail.com" class="footer-link">
