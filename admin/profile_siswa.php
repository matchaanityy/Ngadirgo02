...
<div class="container mt-5">
    <h3 class="mb-4 text-center">Data Jumlah Siswa SDN Ngadirgo 02</h3>

    <div class="text-end mb-3">
        <a href="tambah_siswa.php" class="btn btn-primary mt-4">Tambah</a>
    </div>
    ...
    <table class="table table-bordered mt-4 text-center align-middle">
        ...
        <tbody>
            <?php
            $no = 1;
            $query = mysqli_query($conn, "SELECT * FROM profile_siswa ORDER BY id_kelas ASC");
            ...
            <tr>
                ...
                <td>
                    <a href="edit_siswa.php?id_kelas=<?= $row['id_kelas']; ?>" class="btn btn-warning btn-sm">Edit</a>
                    <a href="delete_siswa.php?id_kelas=<?= $row['id_kelas']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus?')">Delete</a>
                </td>
            </tr>
            <?php } ?>
        </tbody>
