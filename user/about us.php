...
<body>
        ...
        <div class="col-md-4">
            <div class="card text-center h-100 shadow">
            <img src="../image/cs.webp" class="card-img-top mx-auto mt-3" alt="Foto" style="width: 270px;">
            <div class="card-body">
                <p class="card-text text-white" style="font-size: 20px;">KONTAK</p>
                <p class="card-text text-white" style="font-size: 14px;"> E-mail :sdnngadirgo02mijen@gmail.com<br>
                Telp : +62858-5667-3171</p>  
            </div>
            </div>
        </div>
        ...
        <div class="col-sm-4">
            <div class="card text-center h-100 shadow">
            <img src="../image/jam.png" class="card-img-top mx-auto mt-3" alt="Foto" style="width: 270px;">
            <div class="card-body">
                <p class="card-text text-white" style="font-size: 20px;">JAM KERJA</p>
                <p class="card-text text-white" style="font-size: 14px;">Senin - Kamis : Pukul 07.00 - 14.00 WIB<br>
                Jumat : Pukul 07.00 - 11.30 WIB<br>Sabtu : Pukul 07.00 - 12.30 WIB:</p>
            </div>
            </div>
        </div>
        </div>
