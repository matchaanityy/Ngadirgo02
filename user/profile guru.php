...
<body>
    ...
    <div class="container">
    <h2 class="text-center judul-section py-2 rounded">Data tenaga Kependidikan SDN Ngadirgo 02</h2></div>
    ...
    <div class="row justify-content-center mt-3 g-4 py">
      ...
      <div class="col-md-2 col-sm-4">
        <div class="card text-center h-100 shadow">
          <img src="../image/foto user.png" class="card-img-top mx-auto mt-3" alt="Foto" style="width: 60px;">
          <div class="card-body">
            <p class="card-text text-white">Asri Zaman Noor, S.Pd<br>Guru Kelas 1</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-2 col-sm-4">
        <div class="card text-center h-100 shadow">
          <img src="../image/foto user.png" class="card-img-top mx-auto mt-3" alt="Foto" style="width: 60px;">
          <div class="card-body">
            <p class="card-text text-white">Anik Swanto Dewi, S.Pd<br>Guru Kelas 2</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-2 col-sm-4">
        <div class="card text-center h-100 shadow">
          <img src="../image/foto user.png" class="card-img-top mx-auto mt-3" alt="Foto" style="width: 60px;">
          <div class="card-body">
            <p class="card-text text-white">Tristanto, S.Pd<br>Guru Kelas 3</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-2 col-sm-4">
        <div class="card text-center h-100 shadow">
          <img src="../image/foto user.png" class="card-img-top mx-auto mt-3" alt="Foto" style="width: 60px;">
          <div class="card-body">
            <p class="card-text text-white">Totty Nugroho, S.Pd<br>Guru Kelas 4</p>
          </div>
        </div>
      </div>
