...
<body>
        ...
        <h2>Seluruh Siswa Kelas 6 Dinyatakan Lulus dengan Nilai yang Memuaskan</h2>
        ...
        <div class="berita-gambar-wrapper">
        <img src="../image/kelulusan sd.jpg" alt="Kelulusan Siswa" class="berita-gambar">
        <img src="../image/kelulusan 2.jpg" alt="Kelulusan Siswa" class="berita-gambar">
        </div>
        </div>
