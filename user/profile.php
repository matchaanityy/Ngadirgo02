...
<body>
    <header>
        ...
        <section class="visi-section text-center py-5">
            <h2>Lorem Ipsum</h2>
            <div class="container mt-4">
                <div class="row justify-content-center">
                    <div class="col-md-3">
                        <h5>VISI SEKOLAH</h5>
                        <div class="visi-box p-3 text-white">
                            <p>“Terwujudnya lulusan yang beriman, berakhlak mulia, menguasai IPTEK, mampu berpikir dan bertindak secara efektif dan kreatif”</p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <h5>VISI SEKOLAH</h5>
                        <div class="visi-box p-3 text-white">
                            <ol class="text-start">
                                <li>Menghayati sikap dan perilaku religius di lingkungan dalam dan luar sekolah.</li>
                                <li>Menetapkan budaya gemar membaca, rasa ingin tahu, berorientasi.</li>
                                <li>Menciptakan sekolah yang rapi, hijau, indah, dan nyaman.</li>
                                <li>Menjadikan pembelajaran sebagai proses menyenangkan, mengembangkan, komunikatif.</li>
                                <li>Meningkatkan kegiatan ekstrakurikuler (Pramuka, sepak takraw, menari, seni, dll).</li>
                                <li>Menanamkan kepedulian sosial dan lingkungan cinta damai, tanah air, semangat kebangsaan dan hidup demokratis.</li>
                            </ol>
                        </div>
                    </div>
                </div>
