...
<body>
    <header>
        ...
        <div class="container-galeri">
            ...
            <figure class="figure">
                <img src="../image/gambar 6.jpeg" class="figure-img img-fluid rounded" alt="gambar 6">
                <figcaption class="figure-caption">A caption for the above image.</figcaption>
            </figure>

            <figure class="figure">
                <img src="../image/gambar 7.jpeg" class="figure-img img-fluid rounded" alt="gambar 7">
                <figcaption class="figure-caption">A caption for the above image.</figcaption>
            </figure>

            <figure class="figure">
                <img src="../image/gambar 8.jpeg" class="figure-img img-fluid rounded" alt="gambar 8">
                <figcaption class="figure-caption">A caption for the above image.</figcaption>
            </figure>
        </div>
        </div>
