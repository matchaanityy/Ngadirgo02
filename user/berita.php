...
<body>
        ...
        <div class="berita-card">
            <img src="../image/band 2.jpg" alt="Juara Marching Band">
            <div class="berita-caption">Juara 1 Marching Band Nada Kita
            </div>
        </div>

        <div class="berita-card">
            <img src="../image/kelulusan sd.jpg" alt="Kelulusan Kelas 6">
            <div class="berita-caption">Pengumuman Kelulusan Kelas 6</div>
        </div>

        <div class="berita-card">
            <img src="../image/gambar 4.jpeg" alt="Kelulusan Kelas 6">
            <div class="berita-caption">Selamat Meraih Akreditasi A</div>
        </div>

        <div class="berita-card">
            <img src="../image/gambar 7.jpeg" alt="Kelulusan Kelas 6">
            <div class="berita-caption">Pengumuman SPMB</div>
        </div>
        </div>
        </div>
