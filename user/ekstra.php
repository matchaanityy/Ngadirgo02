...
<body>
        ...
        <div class="container">
        <h2 class="text-center judul-section mt-4 py-2 rounded">Data Ekstrakurikuler SDN Ngadirgo 02</h2></div>

        <div class="container">
        <div class="card-ekstra">
        <div class="row justify-content-center mt-3 g-4 py">
        <!-- CARD 1 -->
        <div class="col-md-4">
            <div class="card text-center h-100 shadow">
            <img src="../image/pramuka.jpeg" class="card-img-top mx-auto mt-3" alt="Foto" style="width: 325px;">
            <div class="card-body">
                <p class="card-text text-white" style="font-size: 20px;">Pramuka</p>
            </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            ...
            <img src="../image/pramuka.jpeg" class="card-img-top mx-auto mt-3" alt="Foto" style="width: 325px;">
            <div class="card-body">
                <p class="card-text text-white" style="font-size: 20px;">Tari</p>
            </div>
            </div>
        </div>
        ...
        <div class="col-sm-4">
            <div class="card text-center h-100 shadow">
            <img src="../image/drumband.jpg" class="card-img-top mx-auto mt-3" alt="Foto" style="width: 325px;">
            <div class="card-body">
                <p class="card-text text-white" style="font-size: 20px;">Drumband</p>
            </div>
            </div>
        </div>
        </div>
