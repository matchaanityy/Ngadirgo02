...
<body>
        ...
        <div class="container">
        <h2 class="text-center judul-section py-2 rounded">Data Fasilitas SDN Ngadirgo 02</h2></div>
    ...
    <div class="row justify-content-center mt-3 g-4 py">
      ...
      <div class="col-md-4">
        <div class="card text-center h-100 shadow">
          <img src="../image/ruang guru.jpeg" class="card-img-top mx-auto mt-3" alt="Foto" style="width: 300px;">
          <div class="card-body">
            <p class="card-text text-white" style="font-size: 20px;">Ruang guru</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-4">
        <div class="card text-center h-100 shadow">
          <img src="../image/ruang tu.webp" class="card-img-top mx-auto mt-3" alt="Foto" style="width: 300px; border-radius: 5px;">
          <div class="card-body">
            <p class="card-text text-white" style="font-size: 20px;">Ruang TU</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-4">
        <div class="card text-center h-100 shadow">
          <img src="../image/ruang kelas.jpg" class="card-img-top mx-auto mt-3" alt="Foto" style="width: 300px;">
          <div class="card-body">
            <p class="card-text text-white" style="font-size: 20px;">Ruang Kelas</p>
          </div>
        </div>
      </div>
</div>
